...
const styles = {
  ...
  kind: {
    primary: 'text-button-primary-text bg-button-primary-background hover:text-button-primary-hover-text hover:bg-button-primary-hover-background border-transparent',
    secondary: 'text-button-secondary-text bg-button-secondary-background hover:text-button-secondary-hover-text hover:bg-button-secondary-hover-background border-transparent',
    disabled:
